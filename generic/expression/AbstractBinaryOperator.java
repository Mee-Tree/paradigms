...
public abstract class AbstractBinaryOperator<T extends Number> implements CommonExpression<T> {
    ...
    protected AbstractBinaryOperator(CommonExpression<T> first, CommonExpression<T> second, Operation<T> operation, int priority) {
        this.first = first;
        this.second = second;
    ...
    public boolean equals(Object o) {
        ...
        AbstractBinaryOperator<T> that = (AbstractBinaryOperator<T>) o;
    ...
    public String wrap(CommonExpression<T> expression, boolean brackets) {
        if (brackets) {
